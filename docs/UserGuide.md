...
5. Type the command in the command box and press `Enter` to execute it.
   ...
   * **`delete`** `flset 3` : Deletes the 3rd FLASHCARDSET in the current list of FLASHCARDSETs.
...
There are also no limit to how much FLASHCARD sets you can make, and same goes to the amount of FLASHCARDs in a FLASHCARDSET. 
...
### 3.6. Auto-save
In StudyBananas, all TASK, FLASHCARDs and QUIZ attempts you create will generate a JSON file named after the respective feature. These files can be found in the data folder, under the directory that you have previously stored the StudyBananas JAR file in. This folder stores all your study-related data created using StudyBananas.
...
All TASK, FLASHCARDs and QUIZ attempts created will be automatically saved, so there is no need for 
...
[4.1.3. List all your tasks](#413-list-all-your-tasks-list-task) <br>
...
[4.2.3. List flashcards in a flashcardset](#423-list-flashcards-in-a-flashcardset-list-fl) <br>
...
If you would like to create a new FLASHCARDSET, this commands allows you to create a new FLASHCARDSET with a custom name to store and categorize your FLASHCARDs.
...
| ![info_icon](images/UG/info_icon.png)            | This deletes all the FLASHCARDs in the FLASHCARDSET, including its last QUIZ attempt.                                                                 |
...
#### 4.2.3. List FLASHCARDs in a FLASHCARDSET: `list fl`
...
| ------------------------------------- | :---------------------------------------------------------------------------------------|
| Example                               | `list fl 1`                                                                             |
| ![tip_icon](images/UG/tip_icon.png)   | Alternatively, you can click on the FLASHCARDSET in the GUI to view its FLASHCARDs. |
...
Already have some FLASHCARDs and would like to start a recap session? 
...
Steps 4.3.1.1-4.3.1.3 are repeated until all FLASHCARDs in the FLASHCARDSET are displayed and answered.
